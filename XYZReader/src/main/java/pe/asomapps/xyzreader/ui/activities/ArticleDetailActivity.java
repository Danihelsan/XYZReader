...
public class ArticleDetailActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPager = (ViewPager) findViewById(pe.asomapps.xyzreader.R.id.pager);
        ...
        mUpButtonContainer = findViewById(pe.asomapps.xyzreader.R.id.up_container);

        mUpButton = findViewById(pe.asomapps.xyzreader.R.id.action_up);
